 ...
 */
final class Version20220316154237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD firstname VARCHAR(80) NOT NULL, ADD lastname VARCHAR(90) NOT NULL');
    }
